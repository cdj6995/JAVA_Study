...
public class Libraryview {
	...
	public void showrentstate() {
		...
		try {
			fos = new FileOutputStream("project01/rentlist.txt");
			...
			for(int i = 0; i < rentmemberlist.size(); i++) {
				...
				dos.writeUTF(rentmemberlist.get(i).get(0) + " / " + rentmemberlist.get(i).get(1) + " / " + rentmemberlist.get(i).get(2) + "\n");
			}
			dos.flush();
			System.out.println(" * rentlist에 저장 완료....");
